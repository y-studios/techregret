...
export function StatsBento({ migrations }: { migrations: Migration[] }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#e2e5e5] bg-white p-5 sm:p-6">
      <div className="pointer-events-none absolute -right-10 -top-16 h-56 w-56 rounded-full bg-[#a981ff] opacity-[0.06] blur-3xl" />
      <div className="pointer-events-none absolute -bottom-16 left-1/3 h-48 w-48 rounded-full bg-[#3ea8ff] opacity-[0.06] blur-3xl" />
      ...
      <div className="relative grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-xl border border-[#e2e5e5] bg-[#f9fafa] p-3.5">
          ...
          <p className="font-display mt-1 text-2xl font-extrabold text-[#0f131a]">{total}</p>
        </div>
        <div className="rounded-xl border border-[#e2e5e5] bg-[#f9fafa] p-3.5">
          <p className="text-[11px] font-bold text-[#8f9faa]">出典付きの実企業事例</p>
          <p className="font-display mt-1 text-2xl font-extrabold text-[#0f131a]">{realCases}</p>
        </div>
        <div className="rounded-xl border border-[#e2e5e5] bg-[#f9fafa] p-3.5">
          <p className="text-[11px] font-bold text-[#8f9faa]">累計「わかる」</p>
          <p className="font-display mt-1 text-2xl font-extrabold text-[#0f131a]">{totalUpvotes}</p>
        </div>
